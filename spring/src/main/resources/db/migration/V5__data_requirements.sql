...
ALTER TABLE verification_data ADD COLUMN IF NOT EXISTS repo_url TEXT;
ALTER TABLE verification_data ADD COLUMN IF NOT EXISTS commit_hash VARCHAR(128);
ALTER TABLE verification_data ADD COLUMN IF NOT EXISTS pr_number INTEGER;
ALTER TABLE verification_data ADD COLUMN IF NOT EXISTS code TEXT;
...
ALTER TABLE work_context ADD COLUMN IF NOT EXISTS display_repo_url TEXT;
ALTER TABLE work_context ADD COLUMN IF NOT EXISTS display_commit_hash VARCHAR(128);
ALTER TABLE work_context ADD COLUMN IF NOT EXISTS display_pr_number INTEGER;
ALTER TABLE work_context ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ NOT NULL DEFAULT now();
...
ALTER TABLE risk_assessment ADD COLUMN IF NOT EXISTS analysis_run_id UUID;
ALTER TABLE risk_assessment ADD COLUMN IF NOT EXISTS finding_id VARCHAR(128);
ALTER TABLE risk_assessment ADD COLUMN IF NOT EXISTS finding TEXT;
ALTER TABLE risk_assessment ADD COLUMN IF NOT EXISTS evidence TEXT;
ALTER TABLE risk_assessment ADD COLUMN IF NOT EXISTS model_version VARCHAR(128);
ALTER TABLE risk_assessment ADD COLUMN IF NOT EXISTS prompt_version VARCHAR(128);
ALTER TABLE risk_assessment ADD COLUMN IF NOT EXISTS source_system VARCHAR(64) NOT NULL DEFAULT 'MIDO';
ALTER TABLE risk_assessment ADD COLUMN IF NOT EXISTS schema_version INTEGER NOT NULL DEFAULT 1;
UPDATE risk_assessment SET source_system = 'MIDO' WHERE source_system IS NULL;
UPDATE risk_assessment SET schema_version = 1 WHERE schema_version IS NULL;
ALTER TABLE risk_assessment ALTER COLUMN source_system SET NOT NULL;
ALTER TABLE risk_assessment ALTER COLUMN schema_version SET NOT NULL;
...
ALTER TABLE decision_log ADD COLUMN IF NOT EXISTS actor_id_hash VARCHAR(128);
ALTER TABLE decision_log ADD COLUMN IF NOT EXISTS source_system VARCHAR(64) NOT NULL DEFAULT 'MIDO';
ALTER TABLE decision_log ADD COLUMN IF NOT EXISTS schema_version INTEGER NOT NULL DEFAULT 1;
UPDATE decision_log SET source_system = 'MIDO' WHERE source_system IS NULL;
UPDATE decision_log SET schema_version = 1 WHERE schema_version IS NULL;
ALTER TABLE decision_log ALTER COLUMN source_system SET NOT NULL;
ALTER TABLE decision_log ALTER COLUMN schema_version SET NOT NULL;
...
ALTER TABLE approval ADD COLUMN IF NOT EXISTS reviewer_id_hash VARCHAR(128);
ALTER TABLE approval ADD COLUMN IF NOT EXISTS action VARCHAR(20);
ALTER TABLE approval ADD COLUMN IF NOT EXISTS reason TEXT;
ALTER TABLE approval ADD COLUMN IF NOT EXISTS source_system VARCHAR(64) NOT NULL DEFAULT 'MIDO';
ALTER TABLE approval ADD COLUMN IF NOT EXISTS schema_version INTEGER NOT NULL DEFAULT 1;
UPDATE approval SET source_system = 'MIDO' WHERE source_system IS NULL;
UPDATE approval SET schema_version = 1 WHERE schema_version IS NULL;
ALTER TABLE approval ALTER COLUMN source_system SET NOT NULL;
ALTER TABLE approval ALTER COLUMN schema_version SET NOT NULL;
